...
class AdminController extends Controller
{
    ...
    public function DocumentosRutas2($idurl,$idurl2)
    {
      ...
      $ArrayCarpetas = array();
      #directorios de archivos
      $ArchivosCarpetas = base_path().'/public/assets/images/documents-admin/'.$idurl.'/'.$idurl2.'';
      $directorio = base_path().'/public/assets/images/documents-admin/'.$idurl.'/'.$idurl2.'';
      ...
      foreach ($getDirectoryCarpetas as $keygetDirectoryCarpetas) {
        $nameCarptea = basename($keygetDirectoryCarpetas);
        $nameCarptea2 = $idurl2.'/'.basename($keygetDirectoryCarpetas);
    ...
    public function DocumentosRutas3($idurl,$idurl2,$idurl3)
    {
      ...
      $ArrayCarpetas = array();
      #directorios de archivos
      $ArchivosCarpetas = base_path().'/public/assets/images/documents-admin/'.$idurl.'/'.$idurl2.'/'.$idurl3.'';
      $directorio = base_path().'/public/assets/images/documents-admin/'.$idurl.'/'.$idurl2.'/'.$idurl3.'';
      ...
      foreach ($getDirectoryCarpetas as $keygetDirectoryCarpetas) {
        $nameCarptea = basename($keygetDirectoryCarpetas);
        $nameCarptea2 = $idurl3.'/'.basename($keygetDirectoryCarpetas);
    ...
    public function DocumentosRutas4($idurl,$idurl2,$idurl3,$idurl4)
    {
      ...
      $ArrayCarpetas = array();
      #directorios de archivos
      $ArchivosCarpetas = base_path().'/public/assets/images/documents-admin/'.$idurl.'/'.$idurl2.'/'.$idurl3.'/'.$idurl4.'';
      $directorio = base_path().'/public/assets/images/documents-admin/'.$idurl.'/'.$idurl2.'/'.$idurl3.'/'.$idurl4.'';
      ...
      foreach ($getDirectoryCarpetas as $keygetDirectoryCarpetas) {
        $nameCarptea = basename($keygetDirectoryCarpetas);
        $nameCarptea2 = $idurl4.'/'.basename($keygetDirectoryCarpetas);
    ...
    public function DocumentosRutas5($idurl,$idurl2,$idurl3,$idurl4,$idurl5)
    {
      ...
      $ArrayCarpetas = array();
      #directorios de archivos
      $ArchivosCarpetas = base_path().'/public/assets/images/documents-admin/'.$idurl.'/'.$idurl2.'/'.$idurl3.'/'.$idurl4.'/'.$idurl5.'';
      $directorio = base_path().'/public/assets/images/documents-admin/'.$idurl.'/'.$idurl2.'/'.$idurl3.'/'.$idurl4.'/'.$idurl5.'';
      ...
      foreach ($getDirectoryCarpetas as $keygetDirectoryCarpetas) {
        $nameCarptea = basename($keygetDirectoryCarpetas);
        $nameCarptea2 = $idurl5.'/'.basename($keygetDirectoryCarpetas);
    ...
    public function uploadNewArchivo(Request $request){
      ...
      elseif($fileUrl != '' && $fileUrl2 != '' && $fileUrl3 != '' && $fileUrl4 == '' && $fileUrl5 == ''){
        $move = $fileDocumento->move(
            base_path().'/public/assets/images/documents-admin/'.$fileUrl.'/'.$fileUrl2.'/'.$fileUrl3.'', $nombreDocumento
        );
        Session::flash('Upload_document', "El Archivo ha sido subido con exito");
        return back()->withInput();
      }
      ...
      elseif($fileUrl != '' && $fileUrl2 != '' && $fileUrl3 != '' && $fileUrl4 != '' && $fileUrl5 == ''){ 
        $move = $fileDocumento->move(
            base_path().'/public/assets/images/documents-admin/'.$fileUrl.'/'.$fileUrl2.'/'.$fileUrl3.'/'.$fileUrl4.'', $nombreDocumento
        );
        Session::flash('Upload_document', "El Archivo ha sido subido con exito");
        return back()->withInput();
      }
    ...
    public function createDirectory(Request $request){
      ...
      #Si la descarga proviene del primer folder que seleccione
      if($fileUrl != '' && $fileUrl2 == ''&& $fileUrl3 == '' && $fileUrl4 == '' && $fileUrl5 == ''){
        \File::makeDirectory(base_path().'/public/assets/images/documents-admin/'.$fileUrl.'/'.$nameDirectorie.'', $mode = 0755, $recursive = true, $force = false);
      ...
      #Si la descarga proviene del segundo folder que seleccione
      elseif($fileUrl != '' && $fileUrl2 != '' && $fileUrl3 == '' && $fileUrl4 == '' && $fileUrl5 == ''){  
        \File::makeDirectory(base_path().'/public/assets/images/documents-admin/'.$fileUrl.'/'.$fileUrl2.'/'.$nameDirectorie.'', $mode = 0755, $recursive = true, $force = false);
      ...
      #Si la descarga proviene del cuarto folder que seleccione
      elseif($fileUrl != '' && $fileUrl2 != '' && $fileUrl3 != '' && $fileUrl4 != '' && $fileUrl5 == ''){ 
        \File::makeDirectory(base_path().'/public/assets/images/documents-admin/'.$fileUrl.'/'.$fileUrl2.'/'.$fileUrl3.'/'.$fileUrl4.'/'.$nameDirectorie.'', $mode = 0755, $recursive = true, $force = false);
