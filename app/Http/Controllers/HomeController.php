...
class HomeController extends Controller
{
    ...
    public function ChatEmpleados()
    {
       ...
       /* foreach ($grpupChat as $keygrpupChat) {
           foreach ($keygrpupChat as $dataKeygrpupChat => $DatavalueKeygrpupChat) {
               ...
               if($prieb  == $idUserLogin){
                // unset($keygrpupChat[$position]);
                 // $idUserConversation = $DatavalueKeygrpupChat['id_user_conversation'];
               }else{
 ...
 // dd($GetUltimateMensage);
        ...
        return view('usuarios.chatUsers', compact('getUsers','GetUltimateMensage'));
    }
