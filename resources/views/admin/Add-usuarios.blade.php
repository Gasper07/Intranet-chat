  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 sectionCenterContenido sectionCenEdituser">
      @if(Session::has('Create_User'))
        <p class="alert alert-success">{{Session::get('Create_User')}}</p>
      @endif
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 DataformPersonales">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 formInputsDats">
              ...
              <select  name="marca_user" required>
                @foreach($marcas as $DataMarcas)
                  <option value="{{ $DataMarcas->id }}">{{ $DataMarcas->marca }}</option>
                @endforeach           
              </select>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 formInputsDats">
              ...
              <select name="sucursal_user" required>
                @foreach($sucursales as $DataSucursal)
                  <option value="{{ $DataSucursal->id }}">{{ $DataSucursal->sucursal }}</option>
                @endforeach          
              </select>
            </div>  
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 formInputsDats">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 formInputsDats">
              ...
              <select name="area_user" required>
                @foreach($areas as $DataAreas)
                  <option value="{{ $DataAreas->id }}">{{ $DataAreas->area }}</option>
                @endforeach        
              </select>     
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 formInputsDats">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 formInputsDats">
              ...
              <select name="Jefe_inmediato_user" required>
                @foreach($usersAll as $DataUsersAll)
                  <option value="{{ $DataUsersAll->id }}">{{ $DataUsersAll->name }}</option>
                @endforeach          
              </select>            
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 formInputsDats">
              ...
              <select name="type_user" required>
                @foreach($roles as $DataRoles)
                  <option value="{{ $DataRoles->tipo_rol }}">{{ $DataRoles->tipo_rol }}</option>
                @endforeach             
              </select>
            </div>
          </div>
