            ...
            success: function(result, index, value, data) {
              ...
              $.each(result, function(index, element) {
                ...
                if(banderaVeriCOunt <= 4){
                  $('.captionUsersInLive>div.accordion>div.title').prepend('<div class="captionCircleUser captionDenoews"><a href="" class="userLive" data-idonline='+dataUseronlineID+'><img class="img-responsive" src="http://app-fd8d1fda-4b1b-423f-aa23-358cd43f64b3.cleverapps.io/public/assets/images/user-leo.png" alt=""></a></div>');
                }else if(banderaVeriCOunt > 4){
                  $('.captionUsersInLive>div.accordion>.content').append('<div class="captionCircleUser captionDenoews"><a href="" class="userLive" data-idonline='+dataUseronlineID+'><img class="img-responsive" src="http://app-fd8d1fda-4b1b-423f-aa23-358cd43f64b3.cleverapps.io/public/assets/images/user-leo.png" alt=""></a></div>');
                }
                console.log('entro');
