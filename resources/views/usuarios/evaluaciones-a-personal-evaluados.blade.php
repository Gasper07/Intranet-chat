     ...
     <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 sectionProfiles sectionPermissionRequest sectionEvalutionToPersonal">
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 EvaluationPersonal">
         ...
         @endforeach
          ...
          @if(Session::has('Evaluacion_Users'))
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ProfileFotosStarts profilesUsersFinish">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 dataEvaluatioNFIna">
               <h3>La evaluación de {{Session::get('Evaluacion_Users')}} ha finalizado</h3>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                
              </div>   
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 detallImgProfile profileSession">              
                <div class="label dataPrubeIm dataProfileEvaluacionesDetallUser" style="background-image: url('http://127.0.0.1/Sites/Intranet-chat/public/assets/profiles/{{Session::get('Evaluacion_UsersFoto')}}')"></div>
              </div>  
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 dataNamesUsers">
                <p class="colorBlack fontMiriamProSemiBold">{{Session::get('Evaluacion_Users')}}</p>

               @foreach ($RankingGeneral as $keyRankingGeneral => $valueRankingGeneral) 
                 @if(Session::get('Evaluacion_UsersId') == $valueRankingGeneral['id_user'])
                         ...
                         @if($evaluaciones->proxima_evaluacion > $MesActual)
                           @if($evaluaciones->mes_evaluacion == $MesActual)
                             ...
                             <a href="evaluacion-a-personal/{{ $encargados->id_encargardo }}/{{$users->id_usuario}}" class="UserYarealizo">
                              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="label dataPrubeIm dataProfileEvaluacionesEvaluados" style="background-image: url('http://127.0.0.1/Sites/Intranet-chat/public/assets/profiles/{{ $users->foto }}')"></div>
