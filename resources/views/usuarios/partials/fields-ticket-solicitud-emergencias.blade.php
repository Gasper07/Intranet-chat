                    ...
                    <div class="modal-dialog dialoDataImgen" role="document">
                      <div class="modal-content">
                        <div class="modal-body">
                          <img class="img-responsive" src="http://127.0.0.1/Sites/Intranet-chat/public/assets/images/documents/{{ $Emergencias->img_adjunta }}" alt="{{ $Emergencias->img_adjunta }}">
                        </div>
          ...
          <div class="dataClicDEsplace deplaceDatSolictudes col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="ui accordion">
              ...
              <div class="content conFormularioReturnMenSage">
                ...
                <form action="http://127.0.0.1/Sites/Intranet-chat/sugerencias_submit" class="formReturnMennsage conteFormSolicitru" method="post" accept-charset="utf-8" enctype="multipart/form-data">
