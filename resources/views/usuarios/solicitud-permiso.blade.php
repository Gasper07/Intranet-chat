    ...
    <div class="row">
     ...
     <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 sectionProfiles sectionPermissionRequest">
       ...
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 permission">
         ...
         <form class="formMotivoPermission" action="solicitud-permiso_submit" method="post" accept-charset="utf-8">
           <textarea name="" placeholder="Describe el permiso"></textarea>
           <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-12 blockSelectPermission">
             ...
             <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 SelecHourPermission">
              <h1>Selecciona  hora</h1>
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 selecDatTime">
                <a href="">
                  <p>Día completo</p>
                </a>
                <input type="hidden">
             ...
             <div class=" col-xs-12 col-sm-6 col-md-4 col-lg-4 SelecDescuentPermission">
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 selecDatTime selecDaySeven">
                 <a href="">
                   <p>Día Septimo</p>
                 </a>
                 <input type="hidden">
